...
Route::group(['middleware' => 'auth'], function () {
	...
	//warehouse dasbord 
	Route::any('wh-incomming-stock', 'Warehouse\WarehouseMainController@incomming_stock_list');
	...
	// listing delivery agent
		...
		Route::any('add-assign-allocation/{item_id}/{sku_code}/{stockId}/{allocation}', 'salesref\assign_ownershipController@add_allocation');
		Route::any('submit-assign-ownership', 'salesref\assign_ownershipController@submit_assign_allocation');
		...
		Route::any('customer-store-list', 'salesref\customer_store\CustomerStoreController@customer_store_list');
		...
		Route::any('admin-assign-allocation/{item_id}/{sku_code}/{stockId}', 'admin_stock\assign_ownershipController@add_allocation');
