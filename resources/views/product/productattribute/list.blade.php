...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Produt-Attribute List  &nbsp;<a href="{{URL('add-Produt-attribute-value')}}" type="button" class="btn btn-dark btn-sm"> Add New</a>
      </h1>

      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{URL('dashboard')}}"><i class="mdi mdi-home-outline"></i> Dashboard</a></li>
        
        <li class="breadcrumb-item active">Produt-Attribute List</li>
      </ol>
    </section>
        ...
        <div class="col-12">         
         <div class="box box-solid bg-gray">
            <div class="box-header with-border">
              <h3 class="box-title">Product Attribute List</h3>
				  ...
				  <table id="example2" class="table table-bordered table-striped">
					...
					@foreach($info as $k=>$tlist)
						<tr>
							...
							<td>{{isset($tlist->value)?$tlist->value:''}}</td>
							
							 <td>
											<?php											
											if($tlist->is_active=='Yes') { ?> <a  onclick="return confirm('Are you sure want to Inactive ?')" 
											href="{{URL('Produt-attribute-value-active/'.base64_encode($tlist->id).'/No')}}" class="label label-success">Active</a> 
											<?php } else {?> <a  onclick="return confirm('Are you sure want to Active ?')" 
											href="{{URL('Produt-attribute-value-active/'.base64_encode($tlist->id).'/Yes')}}" class="label label-danger">Inactive</a>
											<?php } ?>
                                            ...
                                            <td>
                                                <div class="custom_btn_group btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown_menu_rightalign"
                                                        ...
                                                        <a class="dropdown-item" href="{{URL('edit-Produt-attribute-value/'.base64_encode($tlist->id))}}">Edit</a>
                                                        <a class="dropdown-item" onclick="return confirm('Are you sure want to Delete ?')" href="{{URL('delete-Produt-attribute-value/'.base64_encode($tlist->id))}}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
						</tr>
