...
<div class="content-wrapper">
    ...
    <section class="content mob-container">
		@if (session('error-msg'))
					  ...
					  @endif
          <!---- List Item ------>
		  <form id="add_development_plan" action="<?= URL('save-box-info')?>" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
			@csrf
          <div class="box">					
            ...
            <div class="media media-single">
              <div class="media-body">
                <ul class="flexbox flex-justified my-10">
                  ...
                  <p><?= isset($warehouse[0]->address) ? $warehouse[0]->address:''?></p>
                  </li>
                </ul>
                </div>
            </div>
            ...
            <div class="media media-single">
              ...
              <ul class="flexbox flex-justified my-10">
                  ...
                  <li>
                    ...
                    <input type="text" class="form-control" name="qtn_per_box[]" value="<?=isset($packingInfo->quantity_per_box)?$packingInfo->quantity_per_box:''?>">
                  </div>
                  </li>
                  <!--<li>
                    <div class="form-group">
		...
		<div class="media media-single">
              ...
              <div class="media-body" id="box_info">
				  <div class="form-group">
					<label>Box Type</label>
					<select class="form-control" name="box_type[]">
					<option value="">Select</option>
					<?php foreach($BoxType as $boxType){ ?>
					<option value="{{$boxType->id}}">{{$boxType->type}}</option>
					<?php } ?>
					</select>
				  </div>
              <ul class="flexbox flex-justified my-10">
                  ...
                  <li>
                    <div class="form-group">
                    <label >Qty per Box</label>
                    <input type="text" class="form-control" name="qtn_per_box[]">
                  </div>
                  </li>
                  <!--<li>
                    <div class="form-group">
			...
			<input type="hidden" name="box_packing_id[]"  value="">
			@endif
            </div>
			<div style="text-align:center"><a href="javascript:void(0);" class="btn btn-success btn-lg mt-10" onclick="add_box_info()">Add More</a>
			</div>
			<hr>
			<br/>
			...
			<div style="text-align:center"><button type="submit" class="btn btn-success btn-lg mt-1" >Save Packaging Info</button>
			</div>
