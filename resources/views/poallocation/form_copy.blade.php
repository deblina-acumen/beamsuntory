...
<h4 class="box-title text-dark">Allocation</h4>
		  ...
		  <?php foreach($po_details as $po_details_val) { ?>
            <tr>
              ...
              <td><button type="button" class="btn btn-dark btn-sm"  data-toggle="modal" onclick="open_modal(this,'{{$po_details_val->varienceid}}','{{$po_details_val->itemid}}','{{$po_details_val->puchase_order_details_id}}','{{$po_details_val->po_id}}')" >Allocate</button>
              </td>
            </tr>
