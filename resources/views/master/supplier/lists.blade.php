...
<div class="content-wrapper">
    ...
    <section class="content-header">
     <h1>
         Supplier  &nbsp;<a type="button" href="{{URL('add-supplier')}}" class="btn btn-dark btn-sm">Add New</a>
      </h1>
      <ol class="breadcrumb">
		...
		<div class="col-12">
          <div class="box box-solid bg-gray">
            <div class="box-header with-border">
              <h4 class="box-title">All Supplier</h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <label for="checkbox_aa" class="block"></label></th>-->
						  <td>{{isset($infos->supplier_name)?$infos->supplier_name :''}}</td>
						  <td>{{isset($infos->supplier_email)?$infos->supplier_email :''}}</td>
						  <td>{{isset($infos->supplier_phone)?$infos->supplier_phone :''}}</td>
