...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edit Region  &nbsp;<a type="button" href="{{URL('region-master-list')}}" class="btn btn-dark btn-sm">Regions</a>
      </h1>
    ...
    <div class="col-lg-9 col-12">
        ...
        <div class="box-header with-border">
          <h4 class="box-title">Region Details</h4>      
		...
		@if (session('error-msg'))
			  ...
			  @endif
            <form id="add_development_plan" action="{{URL('update-region')}}"
                method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                <!-- Step 1 -->
                @csrf
                @include('master/region/form')
