...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Delivery Agent List  &nbsp;<a href="{{URL('add-delivery-agent')}}" type="button" class="btn btn-dark btn-sm"> Add New</a>
      </h1>

      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{URL('dashboard')}}"><i class="mdi mdi-home-outline"></i> Dashboard</a></li>

        <li class="breadcrumb-item active">Delivery Agent List</li>
      </ol>
    </section>
		...
		<div class="col-12">
          <div class="box box-solid bg-gray">
            <div class="box-header with-border">
              <h4 class="box-title">All Delivery Agent</h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				  ...
				  <table id="example2" class="table table-bordered table-striped">
									...
									@foreach($info as $k=>$tlist)
                                        <tr>
											...
											href="{{URL('delevery-agent-active/'.base64_encode($tlist->userid).'/No')}}" class="label label-success">Active</a>
											<?php } else {?> <a  onclick="return confirm('Are you sure want to Active ?')"
											href="{{URL('delevery-agent-active/'.base64_encode($tlist->userid).'/Yes')}}" class="label label-danger">Inactive</a>
											<?php } ?>
                                            ...
                                            <td>
                                                <div class="custom_btn_group btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown_menu_rightalign"
                                                        ...
                                                        <a class="dropdown-item" href="{{URL('delivery-agent-edit/'.base64_encode($tlist->userid))}}">Edit</a>
                                                        <a class="dropdown-item" onclick="return confirm('Are you sure want to Delete ?')" href="{{URL('delete-delivery-agent/'.base64_encode($tlist->userid))}}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
