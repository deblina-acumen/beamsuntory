 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Add Delivery Agent  &nbsp;<a href="{{URL('delivery-agent-list')}}" type="button" class="btn btn-dark btn-sm"> Delivery Agent</a>
      </h1>
		...
		<div class="col-lg-12 col-12">
			<div class="box box-solid bg-gray">
				...
				<div class="box-header with-border">
				  <h4 class="box-title">Add New Delivery Agent</h4>      
				...
				<!-- /.box-header -->
					...
					<form id="add_development_plan" action="<?= URL('save-delivery-agent-data')?>"
