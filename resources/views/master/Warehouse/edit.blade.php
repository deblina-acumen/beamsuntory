...
<div class="content-wrapper">
    ...
    <h1>
        Edit Warehouse  &nbsp;<a type="button" href="{{URL('warehouse-list')}}" class="btn btn-dark btn-sm">Warehouses</a>
      </h1>
    ...
    <div class="col-lg-9 col-12">
		...
		@if (session('error-msg'))
			  ...
			  @endif
            <form id="add_development_plan" action="{{URL('update-warehouse')}}"
                method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                <!-- Step 1 -->
                @csrf
                @include('master/Warehouse/form')
...
function get_province(obj)
{
	var country = $(obj).val(); 
 $.ajax({
		url:'<?php echo URL("get-warehouse-province-by-country-id"); ?>',
		method:"POST",
		dataType: 'json',
		data: {
		"country_id": country,
