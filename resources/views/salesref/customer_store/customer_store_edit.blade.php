				...
				<div class="media media-single">
						  <div class="media-body">
 						  ...
 						  <div class="media-right">
							<a class="btn btn-block btn-dark btn-sm" href="{{URL('customer-store-list')}}">Back</a>
						  </div>
						</div>
				<form id="add_development_plan" action="<?= URL('update-customer--store')?>" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
				@csrf
				@include('salesref/customer_store/customer_store_form')
