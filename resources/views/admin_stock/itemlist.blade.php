	...
	<form id="item_list" method="post" action="<?= URL('item-list-change-privacystatus')?>" class="needs-validation" novalidate enctype="multipart/form-data">
		...
		<div class="media-list media-list-hover media-list-divided">
            ...
            <div class="media media-single m-media">
              ...
              <div class="pull-left">
                &nbsp;
                  <img src="{{isset($product_list_val->image) && $product_list_val->image!=''?URL('public/product/'.$product_list_val->image):asset('assets/images/150x100.png')}}" class="m-td-pic" style="margin-right:30px;">
              </div>
