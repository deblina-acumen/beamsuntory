        ...
        <div class="box-header with-border">
          ...
          <ul class="box-controls pull-right">
            <li><a class="box-btn-fullscreen" href="#"></a></li>
					...
					<form id="add_development_plan" action="<?= URL('update-po-steop1')?>"
